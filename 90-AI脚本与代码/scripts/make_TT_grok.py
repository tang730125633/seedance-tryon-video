...
输出 output_grok/story/TT{n}_grok.mp4"""
...
SRC = f"{DIR}/output_xiaole/scenes/楼顶天台.png"
...
BEATS = [
    (1, "团队成员在天台上伸懒腰、深呼吸，享受阳光"),
    (2, "团队成员摆pose、比耶手势、勾肩搭背拍合照"),
    (3, "团队成员被大风吹得头发乱飞、捂头、踉跄，狼狈"),
    (4, "团队成员玩团建游戏、夸张动作、互相推搡，欢乐"),
    (5, "团队成员突然表情一凝、低头看手机，气氛变了"),
    (6, "团队成员齐刷刷蹲下或瘫坐在地上、仰天叹气"),
]

def do(b): return (b[0], gen(b[0], b[1], f"{OUT}/TT{b[0]}_grok.mp4"))
