...
输出 output_grok/story/clip{n}_grok.mp4"""
...
BEATS = [
    (1, "团队成员抬头互相点头打招呼，自然微笑，元气满满的早晨氛围，镜头缓缓推进"),
    (2, "成员们专注看着笔记本屏幕认真讨论，点头交流，有人手指屏幕"),
    (3, "成员们表情凝重，皱眉思考、轻轻叹气、扶额，遇到难题的紧张气氛"),
    (4, "坐着的白T恤男生突然眼睛一亮兴奋地指向屏幕，其他人惊喜凑近，节奏加快"),
    (5, "成员们一起开心欢呼、举手击掌庆祝，笑容灿烂，热烈喜悦"),
]

def do(b): return (b[0], gen(b[0], b[1], f"{OUT}/clip{b[0]}_grok.mp4"))
