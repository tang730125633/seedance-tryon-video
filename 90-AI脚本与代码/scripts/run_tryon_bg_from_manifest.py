...
def main():
    ...
    for item in clients:
        ...
        save_json(client_dir / "01_tryon_task.json", tryon_meta)
        tryon_video = str(tryon_paths[0])

        print(f"== {client_id} background ==", flush=True)
        bg_meta = submit_bg(rh, tryon_video, item["background"], item.get("seconds", "6"))
