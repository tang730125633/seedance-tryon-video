#!/usr/bin/env python3
"""《全员背锅》5段——grok-video 图生视频(带音频)，高耐性死磕上游窗口。
源图=黄雀团队图，5个剧情动作。grok 上游间歇403，本脚本持续重试直到每段成功。
输出 output_grok/story/BG{n}_grok.mp4"""
...
BEATS = [
    (1, "团队成员盯着屏幕，集体倒吸凉气、捂脸、瞪大眼，惊慌"),
    (2, "一名成员伸手指向旁边，其他人也跟着抬手指别人"),
    (3, "团队成员互相指来指去、摇头摆手、争辩，乱成一团"),
    (4, "一名成员被其他人手指指着，缩成一团、欲哭无泪"),
    (5, "团队成员齐刷刷转头、一起指向画面外同一方向"),
    (6, "团队成员齐刷刷望着同一方向，集体看戏、憋笑表情"),
]

def do(b): return (b[0], gen(b[0], b[1], f"{OUT}/BG{b[0]}_grok.mp4"))
