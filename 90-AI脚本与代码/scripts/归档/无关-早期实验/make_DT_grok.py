...
输出 output_grok/story/DT{n}_grok.mp4"""
...
SRC = f"{DIR}/output_xiaole/scenes/电梯里.png"
...
BEATS = [
    (1, "四人挤进电梯，互相礼貌点头、贴墙站好"),
    (2, "电梯里安静尴尬，四人眼神乱瞟、假装看手机"),
    (3, "电梯突然一震、灯光闪烁，四人惊慌抓扶手、瞪大眼"),
    (4, "四人面面相觑、有人按按钮、有人捶门，慌乱"),
    (5, "四人靠墙滑坐下、叹气、掏零食分着吃，认命"),
    (6, "电梯门突然打开，四人秒变端正站好、表情一致"),
]

def do(b): return (b[0], gen(b[0], b[1], f"{OUT}/DT{b[0]}_grok.mp4"))
