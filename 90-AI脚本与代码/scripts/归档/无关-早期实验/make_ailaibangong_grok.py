#!/usr/bin/env python3
"""《AI来上班》5段——grok-video 图生视频(带音频)，高耐性死磕上游窗口。
源图=黄雀团队图，5个剧情动作。grok 上游间歇403，本脚本持续重试直到每段成功。
输出 output_grok/story/AI{n}_grok.mp4"""
...
BEATS = [
    (1, "团队成员围在桌前，好奇又期待地看着桌上一台平板，身体前倾，眼神发亮"),
    (2, "团队成员同时瞪大眼睛、张大嘴、身体后仰，集体震惊的表情"),
    (3, "团队成员各自夸张地敲键盘、假装打电话、低头狂记笔记，手忙脚乱地装忙"),
    (4, "团队成员凑在屏幕前表情瞬间凝重，有人扶额、有人倒吸凉气，紧张气氛"),
    (5, "团队成员围成一圈交头接耳、坏笑、互相击拳，密谋的样子"),
    (6, "团队成员一起放松地靠在椅背上，翘脚、喝饮料，惬意悠闲地摸鱼"),
]

def do(b): return (b[0], gen(b[0], b[1], f"{OUT}/AI{b[0]}_grok.mp4"))
